...
public class OctreeTest
{
    ...
    {
        var octree = new Octree<Boid>(Vector3.Zero, new Vector3(10, 10, 10), 2);
        octree.Insert(new Boid {Position = new Vector3(0, 0, 0)});
        octree.Insert(new Boid {Position = new Vector3(5, 5, 5)});
        octree.Insert(new Boid {Position = new Vector3(10, 10, 10)});
    ...
    public void TestInsertHasCorrectPosition()
    {
        var octree = new Octree<Boid>(Vector3.Zero, new Vector3(10, 10, 10), 2);
        octree.Insert(new Boid {Position = new Vector3(0, 0, 0)});
        var boid = octree.Points[0];
        AssertVector(boid.Position).IsEqual(new Vector3(0, 0, 0));
    }
    ...
    {
        var octree = new Octree<Boid>(Vector3.Zero, new Vector3(10, 10, 10), 2);
        octree.Insert(new Boid {Position = new Vector3(-2.5f, -2.5f, -2.5f)});
        octree.Insert(new Boid {Position = new Vector3(2.5f, 3f, 2.5f)});
        octree.Insert(new Boid {Position = new Vector3(2.5f, 4f, 2.5f)});
        var points = octree.Query(new Vector3(2.5f, 3.5f, 2.5f), Vector3.One);
        AssertInt(points.Count).IsEqual(2);
        AssertVector(points[0].Position).IsEqual(new Vector3(2.5f, 3f, 2.5f));
        AssertVector(points[1].Position).IsEqual(new Vector3(2.5f, 4f, 2.5f));
    }
    ...
    {
        var octree = new Octree<Boid>(Vector3.Zero, new Vector3(10, 10, 10), 2);
        var boid = new Boid { Position = new Vector3(0f, 0f, 0f) };
        var boidWithNewPosition = boid with { Position = new Vector3(5f, 5f, 5f) };
        octree.Insert(boid);
